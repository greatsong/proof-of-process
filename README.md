...
| **교과별 템플릿** | 일반 / 글쓰기 / 과학탐구 / 코딩 4종 |
| **윤리적 활용 확인** | 모든 루브릭의 Pass/Fail 윤리 체크 (자동 배지 표시) |
...
└── src/
    ...
    │
    ├── data/
    │   └── rubricTemplates.js       # 교과별 루브릭 템플릿 4종 (일반/글쓰기/과학/코딩)
    │
    └── test/                        # 테스트 인프라
...
| **컴포넌트** | 2개 | ChatInput, ErrorBoundary |
